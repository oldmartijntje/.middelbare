...
namespace GDF_pacman
{
    public class room_main : Room
    {
        ...
        public static float playerStepSize = 0.4f;
        ...
        protected override void Start()
        {
            ...
            this.Camera.SetCameraMode_FirstPerson(player, 0f, 0f,  false, false);
           // this.Camera.FieldOfView = 200;
            //teleportatieplekken 
            ...
            this.Text2dCreate("start2", "Druk op S om te starten", 16f, 10.7f, 1f);
        ...
        protected override void Step()
        {
            ...
            if (Game.Input.GetKey(Urho.Key.S) && room_main.ready == false)
            {
        ...
        {
            Instance bigbox = this.InstanceCreate(0.5f * (xright + xleft), 0.5f, .5f * (ztop + zbottom), typeof(instance_box));
            bigbox.Model.Size = new Vector3(xright - xleft + 1, 10f, zbottom - ztop + 1);
